...
RUN apt-get update -qq && apt-get install -y bundler build-essential ruby-rmagick libmariadbclient-dev libfreeimage3 nodejs wget procps  curl cron strace make
